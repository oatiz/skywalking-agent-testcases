...
CLUSTER_NAME=${cluster.name:docker-cluster}
...
java $ELASTICSEARCH_OPTS -Delasticsearch.host=${ELASTICSEARCH_HOST} -Dcluster.name=${CLUSTER_NAME} -jar /usr/local/skywalking-elasticsearch-scenario/elasticsearch-scenario.jar
